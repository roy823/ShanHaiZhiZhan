...
QJsonObject SaveSystem::creatureToJson(const Creature* creature) const {
    ...
    statsObject["speed"] = baseStats.m_speed;
    ...
    for (int i = 0; i < creature->getSkillCount(); ++i) {
        ...
        if (skill) {
            ...
            skillObject["elementType"] = static_cast<int>(skill->getElementType());
    ...
    if (fifthSkill) {
        ...
        skillObject["elementType"] = static_cast<int>(fifthSkill->getElementType());
        skillObject["skillType"] = static_cast<int>(fifthSkill->getSkillType());
...
Creature* SaveSystem::createCreatureFromJson(const QJsonObject& json) const {
    ...
    BaseStats baseStats;
    baseStats.hp = statsObject["hp"].toInt();
    baseStats.attack = statsObject["attack"].toInt();
    baseStats.defense = statsObject["defense"].toInt();
    baseStats.specialAttack = statsObject["specialAttack"].toInt();
    baseStats.specialDefense = statsObject["specialDefense"].toInt();
    baseStats.speed = statsObject["speed"].toInt();
    ...
    Talent talent;
    talent.hpGrowth = talentObject["hpGrowth"].toDouble();
    talent.attackGrowth = talentObject["attackGrowth"].toDouble();
    talent.defenseGrowth = talentObject["defenseGrowth"].toDouble();
    talent.specialAttackGrowth = talentObject["specialAttackGrowth"].toDouble();
    talent.specialDefenseGrowth = talentObject["specialDefenseGrowth"].toDouble();
    talent.speedGrowth = talentObject["speedGrowth"].toDouble();
