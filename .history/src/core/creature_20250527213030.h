...
public:
    ...
    virtual void onTurnEnd(BattleSystem *battle = nullptr);
...
public:
    ...
    // 特殊行为或能力
    virtual void onTurnStart(BattleSystem* battle) override;
    virtual void onTurnEnd(BattleSystem* battle) override;
};
