...
QString StatusConditionEffect::getDescription() const
{
    ...
    switch (m_condition) {
        case StatusCondition::POISONED: conditionName = "中毒"; break;
        case StatusCondition::PARALYZED: conditionName = "麻痹"; break;
...
QString StatChangeEffect::getDescription() const
{
    ...
    switch (m_stat) {
        ...
        case StatType::SPECIAL_ATTACK: statName = "特攻"; break;
        case StatType::SPECIAL_DEFENSE: statName = "特防"; break;
