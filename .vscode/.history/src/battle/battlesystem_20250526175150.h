...
private:
    ...
    void triggerStatusChanged(Creature* target, StatusCondition oldCondition, StatusCondition newCondition); // Ensure you can get oldCondition
    void triggerStatStageChanged(Creature* target, StatType stat, int oldStage, int newStage); // Ensure you can get oldStage
