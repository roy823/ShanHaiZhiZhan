...
private:
    ...
    void updateText() {
        if (m_skill) {
            QString skillType;
            switch (m_skill->getSkillType()) {
                case SkillType::PHYSICAL: skillType = "物理"; break;
                case SkillType::SPECIAL: skillType = "特殊"; break;
                case SkillType::STATUS: skillType = "状态"; break;
            }
